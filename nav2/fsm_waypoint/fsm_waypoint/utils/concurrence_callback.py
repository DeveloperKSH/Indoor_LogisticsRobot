...
def child_termination_cb(outcome_map):
    ...
    return any(outcome in ['succeeded', 'bearing', 'waypoint', 'path', 'create', 'update', 'cancel', 'navfn', 'rmf'] for outcome in outcome_map.values())
...
def outcome_cb(outcome_map):
    ...
    if any(outcome == 'bearing' for outcome in outcome_map.values()):
        ...
        return 'navfn'
    elif any(outcome == 'rmf' for outcome in outcome_map.values()):
        return 'rmf'
